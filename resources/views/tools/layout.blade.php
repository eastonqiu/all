...
<head>
  ...
  <title>@yield('title') 微刻-在线工具大全</title>
  ...
  <meta name="discription" content="微刻网 在线计算机工具 编程工具 常用工具 二维码生成 进制转换 Unix时间戳转换 字符串长度计算 url编码解码 密码随机生成 加密算法">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini">微刻</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">微刻工具大全</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2017-2018 <a href="//tools.vike.xin">微刻工具大全</a>.</strong> All rights
